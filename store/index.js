    ...
    return new Vuex.Store({
        ...
        actions:{
            ...
            nuxtServerInit(vuexContext,context){
                return axios.get("https://nuxt-tutorial-9e4bc.firebaseio.com/posts.json")
                .then(res=>{
                    const data=[];
            ...
            addPost(vuexContext,post){
                ...
                return axios.
                    post("https://nuxt-tutorial-9e4bc.firebaseio.com/posts.json",createPost)
                    .then(res=>{
            ...
            editPost(vuexContext,post){
                return axios.
                    put("https://nuxt-tutorial-9e4bc.firebaseio.com/posts/"+post.id+".json",post)
                    .then(res=>{
                        // commit mutation
